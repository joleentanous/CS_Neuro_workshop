...
def process_video(participant_name):
    ...
    # Construct paths
    video_path = f'C:/Users/jolee/OneDrive/Desktop/vidstocheck/{participant_name}.mp4'
    excel_folder = f'C:/Users/jolee/OneDrive/Desktop/שנה ג/סמסטר ב/workshop/codingWithMP/checkSmiles'
...
# Example usage
process_video('81831646_83_right_knock_knock_4')
